...
public class HeritageFragment extends Fragment {
    ...
    private List<generic_adapter> HERITAGE_ADAPTER_LIST = new ArrayList<>();
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HERITAGE_ADAPTER_LIST.clear();


        myDBHelper = new DatabaseHelper(context);
        Cursor cursor = myDBHelper.getAllHeritage();

        while (cursor.moveToNext()){

            HERITAGE_ADAPTER_LIST.add(new generic_adapter(
    ...
    public class myHeritageListAdapterClass extends ArrayAdapter<generic_adapter> {
        ...
        myHeritageListAdapterClass() {
            super(context, R.layout.list_item, HERITAGE_ADAPTER_LIST);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            generic_adapter current = HERITAGE_ADAPTER_LIST.get(position);
